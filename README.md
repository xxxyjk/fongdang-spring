...
>- 카테고리를 축소하여 타 대형 펀딩 사이트보다 더 전문적인 카테고리로 실용적인 상품들을 접할 수 있게 구현했습니다.
...
>- 소비자, 판매자, 퐁당 관리자간의 원활한 의사소통과 신고 기능으로 적합하지 않은 상품을 관리하여 소비자에게 피해가 가지 않는 사이트를 주안점으로 설계했습니다.
...
## 9. 느낀 점
>- 이전 프로젝트와 다른 환경에서 MyBatis와 Spring framework를 사용함으로써 코드가 더 간결해지고 객체 관리, 로직 처리 측면에서 더 편리함을 느꼈습니다. 또 다양한 API들을 적용해볼 수 있어 좋은 경험이었습니다.
